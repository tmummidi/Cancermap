/*
 * modified to use our modified copy of dom-to-image.js
 * which preserves the state of checkboxes and select elements
 */

var domtoimage = require('./dom-to-image');
var fileSaver = require('file-saver/src/FileSaver');
